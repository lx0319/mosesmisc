...
public final class CommonUtils {
	...
	/**
	 * Returns the index within x of the first occurrence of an any byte inside
	 * specified y, starting the search at the specified index.
	 * 
	 * @param start
	 *            the index to start the search from, inclusive.
	 * @return the index of the first occurrence of the byte inside y in the x.
	 */
	...
	/**
	 * Returns the index within x of the first occurrence of the specified y,
	 * starting the search at the specified index.
	 * 
	 * @param start
	 *            the index to start the search from, inclusive.
	 * @return the index of the first occurrence of the y in the x.
	 */
