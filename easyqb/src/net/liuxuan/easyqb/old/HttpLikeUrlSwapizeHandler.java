...
public class HttpLikeUrlSwapizeHandler implements IHtmlHandler {
	...
	private static final Logger log =
		Logger.getLogger(HttpLikeUrlSwapizeHandler.class.getName());
	...
	public String handling(String html, String charset) throws Exception {
		...
		log.info(String.format("Before handling html content ('%s' encoding charset) => '%s'.", charset, html));
		...
		log.info(String.format("Handling completed. Html content ('%s' encoding charset) => '%s'.", charset, html));
