...
public class HPtest {
    ...
    public static void main(String[] args) {
        String a = FilePlus.ReadTextFileToStringLn("d:/a.txt");
        try {
            doHtmlParse1(a);
        } catch (Exception ex) {
            Logger.getLogger(HPtest.class.getName()).log(Level.SEVERE, null, ex);
        }
    }

    public static void doHtmlParse2(String content) throws ParserException, MalformedURLException, IOException {
...
//		System.out.println(node.toHtml().replaceAll("<div.*>|</.*>|<p.*</p>", "").replaceAll("<br/>", "\r\n").replaceAll("(\r\n){2,}", "\r\n"));
//              resp.getWriter().println(node.toHtml().replaceAll("<div.*>|</.*>|<p.*</p>", "").replaceAll("<br/>", "\r\n").replaceAll("(\r\n){2,}", "\r\n"));
//              System.out.println(node.toHtml().replaceAll("<div.*>|</.*>|<p.*</p>", "").replaceAll("<br/>", "\r\n").replaceAll("(\r\n){2,}", "\r\n"));
            }
    ...
    public static void doHtmlParse1(String content) throws ParserException {
        ...
        NodeFilter filter1 = new HasAttributeFilter("class", "qiushi_body article");
        ...
        NodeFilter filter_ptag = new AndFilter(new HasAttributeFilter("class", "qiushi_body article"), new TagNameFilter("p"));
        Node Node1 = parser_ptag.extractAllNodesThatMatch(filter_ptag).elementAt(1);
        ...
        System.out.println("====================================================");
        System.out.println(node0.toHtml().replaceAll("<div.*>|</.*>|<p.*</p>", "").replaceAll("<br/>", "\r\n").replaceAll("(\r\n){2,}", "\r\n"));
        System.out.println("====================================================");
